            ...
            <div class="content">
                ...
                <div class="container">
                        ...
                        {{-- <div class="col-xl-4">
                            <div class="page-title-box">
                                <div class="count-down">
                                    <div class="count-down__title">Đếm ngược Tết</div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">🐧🐧🐧🐧🐧 Yêu <a href="https://www.facebook.com/profile.php"
                                        style="color: red;text-decoration: revert;">cậu</a> nhiều lắm ó 🤭🤭🤭🤭🤭🤭🤭
                                </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-8 todo-inputbar">
                                                    <input type="text" id="todo-input-text" name="todo-input-text"
                                                        class="form-control" placeholder="Thêm công việc">
                                                </div>
                                        ...
                                        <div class="form-group row text-center mt-4 mb-4">
                                            <div class="col-12">
                                                <button
                                                    ...
                                                    id="random-number-button">Tạo ngẫu nhiên</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <input class="form-control" type="text" id="document-search"
                                                        required placeholder="Nhập từ khóa tìm kiếm">
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="nav flex-column nav-pills tabs-vertical" role="tablist"
                                                        ...
                                                        <a class="nav-link category-link mb-2" id="v-all-tab"
                                                            ...
                                                            aria-controls="v-all" aria-selected="true">Tất cả</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-9">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row text-center mt-4 mb-4">
                                            <div class="col-12">
                                                <button
                                                    class="btn btn-md btn-block btn-primary waves-effect waves-light"
                                                    id="document-post">Cung cấp</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="docs-data">
                                                    <div class="input-group mt-2">
                                                        <span class="input-group-prepend">
                                                            <label class="input-group-text width-xs" for="dataX">Tọa độ
                                                                X</label>
                                                        </span>
                                                    ...
                                                    <div class="input-group mt-2">
                                                        <span class="input-group-prepend">
                                                            <label class="input-group-text width-xs" for="dataY">Tọa độ
                                                                Y</label>
                                                        </span>
                                                            ...
                                                            <div style="text-align: end;"
                                                                ...
                                                                <div class="btn-group">
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Dịch trái">
                                                                    ...
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Dịch phải">
                                                                    ...
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Dịch lên">
                                                                ...
                                                                <div class="btn-group">
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        title="Rotate Left">
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Xoay trái">
                                                                            Xoay trái
                                                                    ...
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        title="Rotate Right">
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Xoay phải">
                                                                            Xoay phải
                                                                ...
                                                                <div class="btn-group">
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        title="Lật ngang">
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Lật ngang">
                                                                            Lật ngang
                                                                            <span
                                                                    ...
                                                                    <button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        title="Lật dọc">
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Lật dọc">
                                                                            Lật dọc
                                                                ...
                                                                <div class="btn-group w-100">
                                                                    <label class="btn btn-danger mb-0 btn-upload btn-lg"
                                                                        ...
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Tải ảnh lên">
                                                                            Upload
                                                                ...
                                                                <div class="btn-group btn-group-crop w-100">
                                                                    <button type="button"
                                                                        ...
                                                                        <span class="docs-tooltip" data-toggle="tooltip"
                                                                            data-animation="false" title="Cắt">Cắt
                                                                        </span>
                                                                    </button>
                                                                </div>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="getCroppedCanvasTitle">Ảnh đã
                                                                                    cắt</h5>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a class="btn btn-outline-info"
                                                                                    ...
                                                                                    download="cropped.jpg">Tải xuống</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
